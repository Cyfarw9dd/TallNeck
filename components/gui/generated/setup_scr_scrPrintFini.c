...
void setup_scr_scrPrintFini(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->scrPrintFini, 240, 536);
	...
	lv_obj_set_size(ui->scrPrintFini_contBG, 240, 536);
	...
	lv_obj_set_pos(ui->scrPrintFini_btnNxet, 81, 415);
	lv_obj_set_size(ui->scrPrintFini_btnNxet, 78, 76);
	...
	lv_obj_set_style_radius(ui->scrPrintFini_btnNxet, 37, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrPrintFini_btnNxet, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->scrPrintFini_imgIconOk, &_ready_alpha_55x55);
	lv_img_set_pivot(ui->scrPrintFini_imgIconOk, 55,55);
	lv_img_set_angle(ui->scrPrintFini_imgIconOk, 0);
	lv_obj_set_pos(ui->scrPrintFini_imgIconOk, 92, 70);
	lv_obj_set_size(ui->scrPrintFini_imgIconOk, 55, 55);
	...
	lv_obj_set_pos(ui->scrPrintFini_labelPrompt, 36, 331);
	lv_obj_set_size(ui->scrPrintFini_labelPrompt, 167, 63);
	...
	lv_obj_set_style_text_font(ui->scrPrintFini_labelPrompt, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
