...
void setup_scr_scrPrintMobile(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->scrPrintMobile, 240, 536);
	...
	lv_obj_set_size(ui->scrPrintMobile_contBG, 240, 536);
	...
	lv_img_set_src(ui->scrPrintMobile_imgPrinter, &_printer2_alpha_43x167);
	lv_img_set_pivot(ui->scrPrintMobile_imgPrinter, 55,55);
	lv_img_set_angle(ui->scrPrintMobile_imgPrinter, 0);
	lv_obj_set_pos(ui->scrPrintMobile_imgPrinter, 62, 130);
	lv_obj_set_size(ui->scrPrintMobile_imgPrinter, 43, 167);
	...
	lv_img_set_src(ui->scrPrintMobile_imgWave, &_wave_alpha_10x65);
	lv_img_set_pivot(ui->scrPrintMobile_imgWave, 50,50);
	lv_img_set_angle(ui->scrPrintMobile_imgWave, 0);
	lv_obj_set_pos(ui->scrPrintMobile_imgWave, 115, 183);
	lv_obj_set_size(ui->scrPrintMobile_imgWave, 10, 65);
	...
	lv_img_set_src(ui->scrPrintMobile_imgPhone, &_phone_alpha_27x137);
	lv_img_set_pivot(ui->scrPrintMobile_imgPhone, 50,50);
	lv_img_set_angle(ui->scrPrintMobile_imgPhone, 0);
	lv_obj_set_pos(ui->scrPrintMobile_imgPhone, 136, 147);
	lv_obj_set_size(ui->scrPrintMobile_imgPhone, 27, 137);
	...
	lv_obj_set_pos(ui->scrPrintMobile_labelPrompt, 27, 342);
	lv_obj_set_size(ui->scrPrintMobile_labelPrompt, 186, 63);
	...
	lv_obj_set_style_text_font(ui->scrPrintMobile_labelPrompt, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrPrintMobile_btnNxet, 90, 423);
	lv_obj_set_size(ui->scrPrintMobile_btnNxet, 60, 76);
	...
	lv_obj_set_style_radius(ui->scrPrintMobile_btnNxet, 37, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrPrintMobile_btnNxet, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
