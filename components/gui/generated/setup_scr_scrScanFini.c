...
void setup_scr_scrScanFini(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->scrScanFini, 240, 536);
	...
	lv_obj_set_size(ui->scrScanFini_contBG, 240, 536);
	...
	lv_img_set_src(ui->scrScanFini_imgIconOk, &_ready_alpha_55x55);
	lv_img_set_pivot(ui->scrScanFini_imgIconOk, 55,55);
	lv_img_set_angle(ui->scrScanFini_imgIconOk, 0);
	lv_obj_set_pos(ui->scrScanFini_imgIconOk, 92, 70);
	lv_obj_set_size(ui->scrScanFini_imgIconOk, 55, 55);
	...
	lv_obj_set_pos(ui->scrScanFini_labelPrompt, 36, 331);
	lv_obj_set_size(ui->scrScanFini_labelPrompt, 167, 63);
	...
	lv_obj_set_style_text_font(ui->scrScanFini_labelPrompt, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrScanFini_btnNxet, 81, 415);
	lv_obj_set_size(ui->scrScanFini_btnNxet, 78, 76);
	...
	lv_obj_set_style_radius(ui->scrScanFini_btnNxet, 37, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrScanFini_btnNxet, &lv_font_montserratMedium_10, LV_PART_MAIN|LV_STATE_DEFAULT);
