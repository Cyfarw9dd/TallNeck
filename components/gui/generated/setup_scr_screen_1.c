...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_1, 240, 536);
    ...
    lv_obj_set_size(ui->screen_1_cont_1, 240, 536);
    ...
    ui->screen_1_list_1_item0 = lv_list_add_btn(ui->screen_1_list_1, LV_SYMBOL_SAVE, "轨道预测");
    ui->screen_1_list_1_item1 = lv_list_add_btn(ui->screen_1_list_1, LV_SYMBOL_SAVE, "时间同步");
    ui->screen_1_list_1_item2 = lv_list_add_btn(ui->screen_1_list_1, LV_SYMBOL_SAVE, "文件内容");
    ui->screen_1_list_1_item3 = lv_list_add_btn(ui->screen_1_list_1, LV_SYMBOL_SAVE, "TLE下载");
    ui->screen_1_list_1_item4 = lv_list_add_btn(ui->screen_1_list_1, LV_SYMBOL_SAVE, "save_4");
    ui->screen_1_list_1_item5 = lv_list_add_btn(ui->screen_1_list_1, LV_SYMBOL_SAVE, "save_5");
    ui->screen_1_list_1_item6 = lv_list_add_btn(ui->screen_1_list_1, LV_SYMBOL_SAVE, "save_6");
    ui->screen_1_list_1_item7 = lv_list_add_btn(ui->screen_1_list_1, LV_SYMBOL_SAVE, "save_7");
    ...
    lv_obj_set_pos(ui->screen_1_list_1, 0, 4);
    lv_obj_set_size(ui->screen_1_list_1, 240, 245);
    ...
    lv_style_set_pad_left(&style_screen_1_list_1_main_main_default, 5);
    lv_style_set_pad_right(&style_screen_1_list_1_main_main_default, 5);
    lv_style_set_pad_bottom(&style_screen_1_list_1_main_main_default, 5);
    lv_style_set_bg_opa(&style_screen_1_list_1_main_main_default, 255);
    lv_style_set_bg_color(&style_screen_1_list_1_main_main_default, lv_color_hex(0xffffff));
    ...
    lv_style_set_border_opa(&style_screen_1_list_1_main_main_default, 255);
    lv_style_set_border_color(&style_screen_1_list_1_main_main_default, lv_color_hex(0xe1e6ee));
    lv_style_set_border_side(&style_screen_1_list_1_main_main_default, LV_BORDER_SIDE_FULL);
    ...
    lv_style_set_bg_color(&style_screen_1_list_1_main_scrollbar_default, lv_color_hex(0xffffff));
    ...
    lv_style_set_pad_left(&style_screen_1_list_1_extra_btns_main_default, 5);
    lv_style_set_pad_right(&style_screen_1_list_1_extra_btns_main_default, 5);
    lv_style_set_pad_bottom(&style_screen_1_list_1_extra_btns_main_default, 5);
    lv_style_set_border_width(&style_screen_1_list_1_extra_btns_main_default, 0);
    lv_style_set_text_color(&style_screen_1_list_1_extra_btns_main_default, lv_color_hex(0x0D3055));
    lv_style_set_text_font(&style_screen_1_list_1_extra_btns_main_default, &lv_font_montserratMedium_12);
    lv_style_set_text_opa(&style_screen_1_list_1_extra_btns_main_default, 255);
    lv_style_set_radius(&style_screen_1_list_1_extra_btns_main_default, 3);
    lv_style_set_bg_opa(&style_screen_1_list_1_extra_btns_main_default, 255);
    lv_style_set_bg_color(&style_screen_1_list_1_extra_btns_main_default, lv_color_hex(0xffffff));
    ...
    lv_style_set_pad_top(&style_screen_1_list_1_extra_texts_main_default, 5);
    lv_style_set_pad_left(&style_screen_1_list_1_extra_texts_main_default, 5);
    lv_style_set_pad_right(&style_screen_1_list_1_extra_texts_main_default, 5);
    lv_style_set_pad_bottom(&style_screen_1_list_1_extra_texts_main_default, 5);
    ...
    lv_style_set_text_font(&style_screen_1_list_1_extra_texts_main_default, &lv_font_montserratMedium_12);
